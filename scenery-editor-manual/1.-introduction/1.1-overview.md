...
## 1.1.4 The Goal of Airport Editing

Airports are created to enhance the app, and the user experience is the top priority. Performance is a large part of that experience.
The goal is to make airports look as good as possible while preserving performance.
Editing is not a contest to see who can create the highest-detailed airport.
While extreme detail might look impressive in a screenshot, it degrades performance and ultimately hurts the overall user experience.
Every choice made should weigh the desire for detail against its impact on performance.
