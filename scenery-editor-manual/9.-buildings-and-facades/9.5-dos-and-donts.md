...
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| :fa-check-circle: Add buildings within the airport boundary, including prominent buildings outside the airport fence which are visible for the pilots and contribute to the character of the airport | :fa-times-circle: Create sloped or vertical round shapes (roofs, walls, arches, ramps, or anything else) using layered buildings or building parts |
...
| :fa-check-circle: Keep the amount of building parts used as small as possible| :fa-times-circle: Make numbers/letters out of buildings      |
| -                                                            | :fa-times-circle: Use building parts to create open doors/windows     |
| -                                                            | :fa-times-circle: Used the "Closed" checkbox on 2 node building parts (As this adds an additional wall)   |
