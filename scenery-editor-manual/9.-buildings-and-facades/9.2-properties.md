...
|Closed|Used to connect the last node with the first with a Wall to enclose a building part|Use this option instead of using an additional node. This should not be used on building parts with only 2 nodes|
