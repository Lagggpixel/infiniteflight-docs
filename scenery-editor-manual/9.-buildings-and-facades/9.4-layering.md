...
![Example of how to add a window to a wall with layering](_images/manual/scenery-editor/buildings-and-facades/layering-diagram.jpg)
...
> If the lowest layer of a building is floating (i.e. not touching the ground level) such as a bridge, this layer will require a new building part. Height should be zero with roof type set to "flat". Then reverse the line points to show the roof from below
