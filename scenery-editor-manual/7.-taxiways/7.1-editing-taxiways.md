...
![Image 7.1.2.1 - Editing Taxiways](_images/manual/frames/6.3.1.1b.png)
...
## Change Line Layer Order

### 7.1.9

If a section of line needs to "painted" on top of another line, such as runway hold lines on top of taxiway centrelines

Step 1

: Tap the line that you want to move to the top

Step 2

: Open the "Pavements" tab on the left side of the screen

Step 3

: Tap on "Move to Top" or "Move Up" as necessary
